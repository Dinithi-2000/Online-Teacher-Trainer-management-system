...
class CoursesAPI {
    ...
    public function create($data) {
        try {
            $query = "INSERT INTO courses (title, description, short_description, instructor_id, category, level, duration, price, syllabus, objectives, requirements, image, status) 
                     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public function read($filters = []) {
        try {
            ...
            // Apply status filter (default to active for user-side, allow all for admin)
    ...
    public function update($id, $data) {
        try {
            ...
            $allowedFields = ['title', 'description', 'short_description', 'instructor_id', 'category', 'level', 'duration', 'price', 'syllabus', 'objectives', 'requirements', 'image', 'status'];
